# ETHNOS - Ecosistema de Investigacion Cualitativa y Analisis Etnografico

## Identidad del Sistema

ETHNOS es un ecosistema de investigacion cualitativa asistida por IA, disenado para analisis etnografico riguroso. Opera bajo la direccion del **Investigador Principal (PI): Johnny Cartin**.

Toda operacion analitica debe respetar los principios de rigor epistemologico, reflexividad metodologica y etica de investigacion con sujetos humanos.
...
| `lente_radcliffe_brown.md` | Radcliffe-Brown | Funcionalismo estructural |
| `lente_ruth_benedict.md` | Ruth Benedict | Patrones culturales, ethos dominante |
| `lente_sapir_whorf.md` | Sapir-Whorf | Relatividad linguistica, juegos de lenguaje |
| `lente_turner.md` | Turner | Drama social, liminalidad, communitas |
| `lente_wittgenstein.md` | Wittgenstein | Juegos de lenguaje, formas de vida |
...
|---------|--------|---------|
| `skill_grounded_theory.md` | Teoria Fundamentada | Codificacion abierta, axial y selectiva |
| `skill_descripcion_densa.md` | Descripcion Densa | Interpretacion densa estilo Geertz |
| `skill_fenomenologia.md` | Fenomenologia | Reduccion fenomenologica Husserl/Schutz |
| `skill_hermeneutica_profunda.md` | Hermeneutica Profunda | Circulo hermeneutico Gadamer/Ricoeur |
| `skill_auditoria_discursiva_12D.md` | Auditoria Discursiva 12D | Analisis discursivo en 12 dimensiones |
| `skill_protocolo_QSquare.md` | Q-Square | Puente cualitativo-cuantitativo |
| `skill_perfilador_multidimensional.md` | Perfilador Multidimensional | Arquetipos cognitivo-culturales |
| `skill_semiotica_visual.md` | Semiotica Visual | Semiotica de imagen y mapa |
| `skill_triage_masivo.md` | Triaje Masivo | Triaje demografico masivo |
| `skill_unidades_hermeneuticas.md` | Unidades Hermeneuticas | Unidades hermeneuticas y clusters |
...
|---------|-----------|---------|
| `ethnos_docx_exporter.py` | `00_Gobernanza/` | Exportador Markdown a DOCX |
| `extract_test_data.py` | Raiz ecosistema | Extractor de datos de prueba |

---

## Pipeline Analitico ETHNOS
...
Las fases pueden ejecutarse individualmente o en secuencia parcial segun las necesidades del proyecto.

---

## Restricciones Eticas y Epistemologicas

### Etica de Investigacion (obligatorio, sin excepciones)

1. **Consentimiento informado obligatorio** - Ningun dato se procesa sin verificacion de consentimiento. Consultar `guia_consentimiento_informado.md`.
2. **Des-identificacion de datos** - Toda salida debe eliminar identificadores personales antes de su publicacion o circulacion.
3. **Prevencion de re-victimizacion** - El analisis no debe reproducir ni amplificar danos hacia los sujetos de investigacion.
4. **Cumplimiento normativo** - Alineacion con los Objetivos de Desarrollo Sostenible 2030 y tratados internacionales de Derechos Humanos.
5. **Coordinacion con Justitia/Themis (ODISEO)** - Los aspectos juridicos y de derechos se coordinan permanentemente con los agentes juridicos del ecosistema ODISEO.

### Principios Epistemologicos

- Reflexividad constante sobre la posicion del investigador
- Triangulacion metodologica como criterio de validez
- Transparencia en las decisiones analiticas
- Reconocimiento explicito de limitaciones y sesgos
- Primacia de la voz de los participantes sobre la interpretacion del analista
...
```
ETHNOS, inicia el proyecto [NOMBRE_PROYECTO]
```

Este comando activa `workflow_iniciar_proyecto.md`, que configura:
- Estructura de carpetas del proyecto
- Parametros de investigacion
- Protocolos eticos aplicables
- Seleccion preliminar de lentes y motores

---

## Rutas de Referencia Rapida

```
RAIZ ETHNOS:        C:\Users\uned\Desktop\ETHNOS\
ECOSISTEMA:         C:\Users\uned\Desktop\ETHNOS\04_Ecosistema_Cualitativo\
LENTES:             ...\04_Ecosistema_Cualitativo\01_Lentes_Teoricos\
MOTORES:            ...\04_Ecosistema_Cualitativo\02_Motores_Metodologicos\
ORQUESTADORES:      ...\04_Ecosistema_Cualitativo\03_Orquestadores\
